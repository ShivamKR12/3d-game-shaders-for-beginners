...
def phy_task():
    ...
    particleSystemManager.do_particles(delta) # type: ignore
    physicsManager.do_physics(delta) # type: ignore
...
base.win.setClearColorActive(True) # type: ignore
base.win.set_clear_depth_active(True) # type: ignore
base.win.set_clear_stencil_active(True) # type: ignore
base.win.set_clear_color(backgroundColor[1]) # type: ignore
...
weatherVaneNP = base.loader.loadModel("../eggs/mill-scene/weather-vane.bam") # type: ignore
weatherVaneNP.reparent_to(sceneRootNP)
bannerNP = base.loader.loadModel("../eggs/mill-scene/banner.bam") # type: ignore
...
smokeNP = setUpParticles(render, smokeTexture, particleSystemManager, physicsManager) # type: ignore
generateLights(render, False) # type: ignore
...
fogNP.set_shader_input("origin",           cameraNP.get_relative_point(render, environmentNP.get_pos())) # type: ignore
